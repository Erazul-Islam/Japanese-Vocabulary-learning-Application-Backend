...
const getUpdatedUserRoleIntoAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getUpdatedUserRoleIntoUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new Error('User not found');
        }
        const updatedProduct = yield user_model_1.User.findOneAndUpdate({ _id: id }, { role: 'USER' }, { new: true });
        return updatedProduct;
    }
    catch (error) {
        console.log(error);
